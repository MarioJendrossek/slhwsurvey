...
pdf("C:/Users/Mario/Sync/Sierra Leone survey/paper/figures/model_coverage.pdf", height = 7, width = 8)
par(mfrow=c(2,1), las=1)
plot(x=1:20, y=coverage, col=pal5[5], xlab = "Time since vaccination campaign (years)", ylab="immunisation coverage (%)", pch=15, ylim=c(0,1))
points(x=0:19, y=coverage_high, col=pal5[1], pch=15)

#par(mfrow=c(1,1), las=1)
plot(x=0:19, y=coverage, col=pal5[5], xlab = "Time since vaccination campaign (years)", ylab="immunisation coverage (%)", pch=15, ylim=c(0,1))
